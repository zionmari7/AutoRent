...
function seedIfEmpty() {
  ...
  // Seed vehicle locations — spread around Calapan City, Oriental Mindoro
  ...
  `);
  [
    { vehicle_id:1,  lat:13.4102, lng:121.1802, speed_kph:38, address:'SM City Calapan' },
    { vehicle_id:2,  lat:13.4130, lng:121.1775, speed_kph:0,  address:'Calapan Public Market' },
    { vehicle_id:3,  lat:13.4138, lng:121.1806, speed_kph:0,  address:'Calapan City Hall' },
    { vehicle_id:4,  lat:13.4095, lng:121.1765, speed_kph:0,  address:'Robinsons Calapan' },
    { vehicle_id:5,  lat:13.4115, lng:121.1792, speed_kph:52, address:'J.P. Rizal Avenue' },
    { vehicle_id:6,  lat:13.4145, lng:121.1760, speed_kph:0,  address:'Service Center' },
    { vehicle_id:7,  lat:13.4088, lng:121.1815, speed_kph:0,  address:'Oriental Mindoro Capitol' },
    { vehicle_id:8,  lat:13.4072, lng:121.1838, speed_kph:0,  address:'Calapan Port (RORO)' },
    { vehicle_id:9,  lat:13.4120, lng:121.1810, speed_kph:29, address:'Calapan Rotonda' },
    { vehicle_id:10, lat:13.4150, lng:121.1788, speed_kph:0,  address:'Sacred Heart College' },
